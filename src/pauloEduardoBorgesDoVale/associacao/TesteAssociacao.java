...
public class TesteAssociacao {
	...
	public void testarPagamento() throws AssociacaoNaoExistente, AssociadoNaoExistente, TaxaNaoExistente, AssociacaoJaExistente, ValorInvalido, AssociadoJaExistente, TaxaJaExistente, AssociadoJaRemido {
		...
		controle.registrarPagamento(1306, "Reforma", 2021, 1, hoje.getTime(), 60);
		valor = controle.somarPagamentoDeAssociado(1306, 1, "Manutencao", 2021, hoje.getTime(), hoje.getTime());
		assertEquals(0, valor, 0.01);
		valor2 = controle.somarPagamentoDeAssociado(1306, 1, "Reforma", 2021, hoje.getTime(), hoje.getTime());
		assertEquals(100, valor2, 0.01);
		controle.registrarPagamento(1306, "Reforma", 2021, 1, hoje.getTime(), 1080);
		valor2 = controle.somarPagamentoDeAssociado(1306, 1, "Reforma", 2021, hoje.getTime(), hoje.getTime());
		assertEquals(1180, valor2, 0.01);
		controle.registrarPagamento(1306, "Reforma", 2021, 1, hoje.getTime(), 20);
		valor2 = controle.somarPagamentoDeAssociado(1306, 1, "Reforma", 2021, hoje.getTime(), hoje.getTime());
